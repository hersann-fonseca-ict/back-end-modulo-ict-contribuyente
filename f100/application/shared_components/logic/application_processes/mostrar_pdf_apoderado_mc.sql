prompt --application/shared_components/logic/application_processes/mostrar_pdf_apoderado_mc
begin
--   Manifest
--     APPLICATION PROCESS: Mostrar_pdf_apoderado_MC
--   Manifest End
...
wwv_flow_api.create_flow_process(
 p_id=>wwv_flow_api.id(191550801069874240)
,p_process_sequence=>1
,p_process_point=>'ON_DEMAND'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Mostrar_pdf_apoderado_MC'
