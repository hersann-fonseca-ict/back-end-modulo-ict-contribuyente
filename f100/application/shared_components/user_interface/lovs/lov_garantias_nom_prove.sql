prompt --application/shared_components/user_interface/lovs/lov_garantias_nom_prove
begin
--   Manifest
--     LOV_GARANTIAS_NOM_PROVE
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(234267144456098033)
,p_lov_name=>'LOV_GARANTIAS_NOM_PROVE'
