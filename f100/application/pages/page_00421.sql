...
,p_name=>'421-Bitacora Funcionarios / Ex Funcionarios'
,p_alias=>'421-BITACORA-FUNCIONARIOS-EX-FUNCIONARIOS'
,p_step_title=>unistr('Bit\00E1cora Funcionarios / Ex Funcionarios')
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'KIMBERLYN.SOLANO'
,p_last_upd_yyyymmddhh24miss=>'20221111132231'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(355378598520689242)
,p_plug_name=>unistr('415-Consulta Bit\00E1cora Funcionarios / Ex Funcionarios')
...
'  where ID_TIPO_CONTRIBUYENTE IN (10)'))
...
,p_prn_page_header=>unistr('415-Consulta Bit\00E1cora Funcionarios / Ex Funcionarios')
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(355378708412689242)
...
,p_internal_uid=>206257929923275200
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(190430115005241640)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(190430542576241641)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(190430963198241642)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(190431739006241642)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(190432554855241642)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(190432942943241643)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(190433315708241643)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(190433746946241643)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(190431363701241642)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(190434491749241644)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(190434977685241644)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(190435316799241646)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(190967087281047387)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(190967215563047388)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(190967355500047389)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(190967388804047390)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(355415729571692788)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'413149'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(475808071891119210)
,p_plug_name=>'Bit Funcionarios / Ex Funcionarios'
...
unistr('<center><h3>Bit\00E1cora Funcionarios / Ex funcionarios</h3></center>')))
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
