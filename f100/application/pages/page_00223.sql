...
,p_name=>'223-Reporte Garantias de cumplimiento'
,p_alias=>'223-REPORTE-GARANTIAS-DE-CUMPLIMIENTO'
,p_step_title=>unistr('Garant\00EDas de cumplimiento')
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_protection_level=>'C'
,p_last_updated_by=>'JORGE.ROJAS'
,p_last_upd_yyyymmddhh24miss=>'20240131111221'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(247499378975447467)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(184524182355692494)
,p_plug_name=>unistr('Garant\00EDas de Cumplimiento')
,p_parent_plug_id=>wwv_flow_api.id(247499378975447467)
...
,p_prn_page_header=>unistr('Garant\00EDas de Cumplimiento')
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(184524664359692494)
,p_name=>'Report 1'
...
,p_detail_link=>'f?p=&APP_ID.:224:&SESSION.::&DEBUG.:RP:P224_ID_CONTRIBUYENTE:\#ID_CONTRIBUYENTE#\'
,p_detail_link_text=>'<span aria-label="Edit"><span class="fa fa-edit" aria-hidden="true" title="Edit"></span></span>'
,p_owner=>'KIMBERLYN.SOLANO'
,p_internal_uid=>35403885870278452
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(184524717661692496)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(184525170800692498)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(184525510279692498)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(184525939996692498)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(184526700639692498)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(184527117234692499)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(184527493378692499)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(184543153053692506)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(184549955596692509)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(186816760396999565)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(186816829890999566)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(247498355023447456)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(184558595955700463)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'354379'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(187046246010456591)
,p_plug_name=>unistr('Garant\00EDas de cumplimiento')
,p_parent_plug_id=>wwv_flow_api.id(247499378975447467)
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(155146499431979459)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(184557625525692515)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(184524182355692494)
...
,p_button_redirect_url=>'f?p=&APP_ID.:224:&SESSION.::&DEBUG.:224'
);
